...
const data = {
  ...
  headband : {
    ...
    presentationText : `
    Ayant une formation appondis à la fois en science et en art, un ingénieur créatif sait manager et opéré 
    au sein d’équipes aux profils variés tels que des développeur logiciel ou web, des graphiques, techniciens
     et artistes pour œuvrer à la réalisation de projets innovants. Grace à une solide culture artistique et 
     technique, il use généralement de sa pluridisciplinarité dans les domaines du jeux vidéo, du web, du 
     multimédia ou encore de l’audiovisuel.`
  },
  skills : {
    ...
    cards : [
      ...
      { // Digital Art
        ...
        bullets : [
          "Développement Backend en Node.js et PHP",
  ...
  metaproject : {
    title : "Mes projets",
    categoriesName : ["Programmation 3D", "Web", "All", "Arts numériques", "Audiovisuel"],
  ...
  projects :
   [
    ...
    { // Projet 2
      ...
      projectLink : ["https://vimeo.com/466817887", "Voir la maquette"],
    ...
    { // Projet 3
      ...
      type : "Arts Nunériques | Décembre 2019",
      categories : ["DigitalArt"],
    ...
    { // Projet 11
      ...
      type : "Programmation 3D | Décembre 2018",
      categories : ["ComputerGraphics"],
